...
public class DocumentService {
    ...
    public TreeNode createDocuments() {
        ...
        TreeNode documents = new DefaultTreeNode(new Document("Documentos", "-", "Folder"), root);
        TreeNode pictures = new DefaultTreeNode(new Document("Imágenes", "-", "Folder"), root);
        TreeNode movies = new DefaultTreeNode(new Document("Videos", "-", "Folder"), root);
